...
.myhover{background:#41dfd0; color:white;transition:all 0.2s ease-in;}
				...
				<nav id="mypagemenu">
					<ul>
						<li><a href=<c:url value='/res/resInfo'/>>내가 예약한 공간</a></li>

						<li><a href=<c:url value='/mypage/myFavList'/>>내가 찜한 공간</a></li>
						<li><a href="<c:url value='/myInfo/QNAList'/>">1:1문의</a></li>
						<li><a href=<c:url value='/member/MemberModifyForm'/>>개인정보 변경</a></li>
						
						<li class="mypagebar">내 공간 관리
			<ul class="mypagehide">
				<li><a href=<c:url value='/mySpace/spaceForm'/>>내 공간 등록하기</a></li>
				<li><a href=<c:url value='/mySpace/SpaceControl'/>>내 공간 관리하기</a></li>
				<li><a href=<c:url value='/mySpace/ResPage'/>>내 공간 예약상황</a></li>
			</ul>
		</li>
					</ul>
